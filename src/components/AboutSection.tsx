    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 text-center">
        <FadeIn delay={0} y={40}>
          ...
          >
            <TextScramble text="ABOUT ME" className="hero-heading" delay={0} speed={0.8} />
          </h2>
        </FadeIn>
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {data.about.skills.map((group) => (
                          ...
                          >
                            <span className="text-xs tracking-widest text-[#D7E2EA]/40 sm:w-44 sm:shrink-0 sm:text-right"
                              style={{ fontFamily: "'Space Mono', monospace" }}>
                              <TextScramble text={group.label.toUpperCase()} delay={0.1} speed={1.5} />
                            </span>
