                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-4 sm:gap-6">
                    <div className="flex flex-row items-start gap-3 sm:gap-6 md:gap-10 min-w-0 w-full">
                      ...
                      <div className="flex flex-col gap-1 sm:gap-3 pt-1 sm:pt-3 md:pt-4 min-w-0 flex-1">
                        <span
                          className="font-light tracking-widest text-[#D7E2EA]/60"
                          style={{ fontSize: 'clamp(0.65rem, 1.2vw, 1rem)', fontFamily: "'Space Mono', monospace" }}
                        >
                          <TextScramble text={project.category.toUpperCase()} delay={0} speed={1.5} />
                        </span>
                        <h3
                          className="font-medium uppercase text-[#D7E2EA] leading-tight"
                          style={{ fontSize: 'clamp(1.1rem, 2.2vw, 2.1rem)' }}
                        >
                          <TextScramble text={project.name.toUpperCase()} delay={0.15} speed={1.2} />
                        </h3>
                      </div>
                    </div>
...
const ProjectsSection = () => {
  ...
  return (
    ...
    >
      <FadeIn y={40}>
        <h2
          className="text-center font-black uppercase tracking-tight leading-none mb-16 sm:mb-20 md:mb-28"
          style={{ fontSize: 'clamp(3rem, 12vw, 160px)' }}
        >
          <TextScramble text="PROJECT" className="hero-heading" delay={0} speed={0.8} />
        </h2>
      </FadeIn>
