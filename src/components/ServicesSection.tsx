...
const ServicesSection = () => {
  ...
  return (
    ...
    >
      <FadeIn y={40}>
        <h2
          className="text-center font-black uppercase mb-16 sm:mb-20 md:mb-28 leading-none"
          style={{ fontSize: 'clamp(3rem, 12vw, 160px)' }}
        >
          <TextScramble text="SERVICES" className="text-[#0C0C0C]" delay={0} speed={0.8} />
        </h2>
      </FadeIn>
          ...
          <FadeIn key={service.number} delay={i * 0.1} y={30}>
            ...
            >
              ...
              <div className="group flex flex-col gap-3 sm:gap-4 md:gap-5 pt-2 sm:pt-3 md:pt-4">
                ...
                >
                  <TextScramble text={service.title.toUpperCase()} delay={0} speed={1.2} />
